...
<html lang="en">
    <head>
        ...
        <script src="https://cdn.tiny.cloud/1/0rv9cslqua47bikram47kmvg3loptg2en0svs0q8mpb1rodf/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        <script>
        tinymce.init({
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Thêm sản phẩm</h3></div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="masanpham" placeholder="Mã sản phẩm" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" name="dongianhap" placeholder="Nhập giá nhập sản phẩm" />
                                                <label for="dongianhap">Đơn giá nhập sản phẩm</label>
                                            </div> 
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" name="dongiaban" placeholder="Nhập giá bán sản phẩm" />
                                                <label for="dongiaban">Đơn giá bán sản phẩm</label>
                                            </div> 
                                             ...
                                             <div class="form-floating mb-3">
                                               ...
                                               <select name="idtheloai">
                                                    <?php while ($row_category=$result_category->fetch_assoc()) {?>
                                                        <option value="<?php echo $row_category['MaLoaiHang'];?>">
