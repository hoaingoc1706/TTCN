                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Sửa loại sản phẩm</h3></div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="idtheloai" value="<?php echo $row['MaLoaiHang'] ?>" readonly/>
                                                <label for="idtheloai">Mã loại sản phẩm</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="tentheloai" value="<?php echo $row['TenLoaiHang'] ?>" />
