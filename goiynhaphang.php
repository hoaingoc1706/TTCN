                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                $sql="
                                SELECT a.MaHang, a.TenHang , a.SoLuong from hanghoa a 
                                join chitietpxh b on a.MaHang=b.MaHang
                                join phieuxuathang c on b.MaPhieuXuatH=c.MaPhieuXuatH
                                where (a.SoLuong<100) AND (CURRENT_DATE()-c.NgayLapPhieu<30) group by a.MaHang HAVING SUM(b.SoLuongXuat)>40
                                ";
                                ...
                                while ($row=$result->fetch_assoc()) {?>
                                    <tr>
                                        ...
                                        <td><a  style="color: white" class="btn btn-primary"  href="z_pnh.php?maSP=<?php echo $row['MaHang']; ?>">Chọn</a></td>
