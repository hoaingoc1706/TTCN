...
<?php
    ...
    //    $noi_luu_anh = "../../Bangiay/images/".basename($_FILES['hinhanh']['name']);
        ...
        // 
        $sql="UPDATE hanghoa SET TenHang = '$tensp' , maloaihang = '$idtheloai', maNCC ='$idnhacungcap',soluong ='$soluong', dongianhap='$dongianhap', dongiaban='$dongiaban' ,DVT='$DVT',mota='$mota' WHERE mahang='".$idsanpham."';";
