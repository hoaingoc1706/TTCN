                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                $sql = "
                                SELECT a.mahang, a.tenhang, a.soluong from hanghoa a JOIN chitietpycxh b on a.mahang=b.mahang JOIN phieuyeucauxuathang c on b.maphieuycxh=c.maphieuycxh
                                WHERE (a.soluong<20) AND (b.soluongxuat>20) AND (CURRENT_DATE()-c.ngaylap<30) ";
